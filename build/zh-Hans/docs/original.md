...
To migrate to Universal sign in, follow [this guide](/zh-Hans/docs/migrating.md#migrating-from-original-to-universal-sign-in).
...
* [Google Sign-In SDK](https://developers.google.com/identity/sign-in/ios/start) for iOS and macOS (macOS support is only available to [in the paid version](/zh-Hans/docs/install.md#premium)).
...
signature: (`options`: [`ConfigureParams`](/zh-Hans/docs/api.md#configureparams)) => `void`
...
signature: (`options`: [`SignInParams`](/zh-Hans/docs/api.md#signinparams)) => `Promise`<[`SignInResponse`](/zh-Hans/docs/api.md#signinresponse)>

Prompts a modal to let the user sign in into your application. Resolved promise returns an [`SignInResponse` object](/zh-Hans/docs/api.md#signinresponse). Rejects with an error otherwise.
...
signature: (`options`: [`AddScopesParams`](/zh-Hans/docs/api.md#addscopesparams)) => `Promise`<[`SignInResponse`](/zh-Hans/docs/api.md#signinresponse) | `null`>
...
signature: () => `Promise`<[`SignInSilentlyResponse`](/zh-Hans/docs/api.md#signinsilentlyresponse)>
...
signature: () => [`User`](/zh-Hans/docs/api.md#user) | `null`
...
signature: () => `Promise`<[`GetTokensResponse`](/zh-Hans/docs/api.md#gettokensresponse)>
...
signature: (`options`: [`HasPlayServicesParams`](/zh-Hans/docs/api.md#hasplayservicesparams)) => `Promise`<`boolean`>
...
![prompt install](/zh-Hans/assets/images/prompt-install-b928a962a8d2c0a416628bffd0c95448.png)
