...
The button will *not render* before the [Google Client API has been loaded](/zh-Hans/docs/setting-up/web.md). You can use the `onError` prop to detect this case.
