...
Parameters for enabling [App Check](/zh-Hans/docs/security.md#appcheck). Provide `debugProviderAPIKey` to enable App Check with [debug provider](https://developers.google.com/identity/sign-in/ios/appcheck/debug-provider).
...
Learn more in the [guide](/zh-Hans/docs/one-tap.md#requestauthorization).
...
| []()`scopes`                              | `string`\[]                                                       | The Google API scopes to request access to. See [scopes docs](/zh-Hans/docs/integration-notes.md#additional-scopes).                                                                        |
...
On the web, the signatures of `signIn`, `presentExplicitSignIn`, and `createAccount` are callback-based and on native they are Promise-based. Read more in the [guide](/zh-Hans/docs/one-tap.md#web-support).
...
| `createAccount`                | (`params?`: [`OneTapCreateAccountParams`](/zh-Hans/docs/api.md#onetapcreateaccountparams)) => `Promise`<[`OneTapResponse`](/zh-Hans/docs/api.md#onetapresponse)>                               |
| []()`enableAppCheck()`         | (`params?`: [`EnableAppCheckParams`](#enableappcheckparams)) => `Promise`<`null`>                                                                                                              |
| `presentExplicitSignIn`        | (`params?`: [`OneTapExplicitSignInParams`](/zh-Hans/docs/api.md#onetapexplicitsigninparams)) => `Promise`<[`OneTapExplicitSignInResponse`](/zh-Hans/docs/api.md#onetapexplicitsigninresponse)> |
...
| `signIn`                       | (`params?`: [`OneTapSignInParams`](/zh-Hans/docs/api.md#onetapsigninparams)) => `Promise`<[`OneTapResponse`](/zh-Hans/docs/api.md#onetapresponse)>                                             |
...
Read more about the meaning of the error codes in the [guide](/zh-Hans/docs/errors.md).
...
When using Universal sign in on the web, the sign in result is delivered via a callback, not via a promise. The shape of data delivered to the callback is the same as the shape of the data in the promise, enabling code reuse. Read more in the [guide](/zh-Hans/docs/one-tap.md#web-support).
