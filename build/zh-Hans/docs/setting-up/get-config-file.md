...
Before getting your hands dirty with code, some configuration needs to be taken care of. Configuration information collected in this guide is used in later steps of the setup and in the `configure()` call: [1](/zh-Hans/docs/one-tap.md#configure) or [2](/zh-Hans/docs/original.md#configure).
...
Use the [Configuration Doctor](/zh-Hans/docs/config-doctor.md). (Requires an [Universal sign in](/zh-Hans/docs/install.md#premium) license.)
...
![Firebase, add Android keystore\&#39;s SHA-1 to your project](/zh-Hans/assets/images/android-fingerprint-firebase-5381019c8870df86888cdc8bb082d603.png)
...
![Google Cloud Console - creating Android OAuth ID](/zh-Hans/assets/images/android-client-id-2a2f8705a27c0cd9f2ed70529d8f29f4.png)
...
![Google Cloud Console - creating iOS OAuth ID](/zh-Hans/assets/images/ios-client-id-0235e70ba063cac062966a2ce5847ed0.png)
