...
After the script is loaded, you can call the functions for signing in and render the [`WebGoogleSigninButton`](/zh-Hans/docs/buttons/web.md).

If you call any of the module functions before the client library is loaded, such calls trigger the [`onError` callback](/zh-Hans/docs/api.md#webonetapsignincallbacks) with the [`PLAY_SERVICES_NOT_AVAILABLE` error code](/zh-Hans/docs/errors.md#status-codes).
...
See [here](/zh-Hans/docs/web-support.md#usage).
