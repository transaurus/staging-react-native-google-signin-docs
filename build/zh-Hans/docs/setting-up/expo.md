...
This package cannot be used in [Expo Go](https://docs.expo.dev/workflow/overview/#expo-go-an-optional-tool-for-learning) because it uses native code. This applies to both the [Original](/zh-Hans/docs/original.md) and [Universal](/zh-Hans/docs/one-tap.md) modules.
...
To obtain `iosUrlScheme`, follow [these instructions](/zh-Hans/docs/setting-up/get-config-file.md?firebase-or-not=cloud-console#ios).
...
If you are using Firebase Authentication, follow [these instructions](/zh-Hans/docs/setting-up/get-config-file.md?firebase-or-not=firebase#step-2) to get `google-services.json` file for Android and [these instructions](/zh-Hans/docs/setting-up/get-config-file.md?firebase-or-not=firebase#ios)) to get `GoogleService-Info.plist` for iOS.
...
Rebuild your app and read the [config guide](/zh-Hans/docs/setting-up/get-config-file.md)!
