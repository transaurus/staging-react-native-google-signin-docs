...
If you use Expo, follow [this guide](/zh-Hans/docs/setting-up/expo.md) instead. This guide applies to vanilla React Native apps only.
...
* Follow [this](/zh-Hans/docs/setting-up/get-config-file.md) guide to get the configuration information which you need for the next steps.
...
![link config](/zh-Hans/assets/images/urlTypes-2096dbcdf48dfe2cb07c1e98f33d423f.png)
